...
(function (ClassiPerCreazioneElementiHTML) {
     ...
     * All'interno della password area l'utente non vedr� in chiaro il testo che scriver�
     ...
     * @class
     */
    class HTMLPswAreaBuilder extends ClassiPerCreazioneElementiHTML.HTMLInputElementBuilder {
        constructor() {
            super();
        }
        /**
         ...
         * @return {ClassiPerCreazioneElementiHTML.HTMLPswAreaBuilder} Il builder
         */
        Value(value) {
            this.addValue(value);
            return this;
        ...
        static newBuilder() {
            ...
            ClassiPerCreazioneElementiHTML.HTMLInputElementBuilder.tipo = "password";
            ClassiPerCreazioneElementiHTML.HTMLElementBuilder.className = "form-control";
            return new HTMLPswAreaBuilder();
        }
    }
    ClassiPerCreazioneElementiHTML.HTMLPswAreaBuilder = HTMLPswAreaBuilder;
    HTMLPswAreaBuilder["__class"] = "ClassiPerCreazioneElementiHTML.HTMLPswAreaBuilder";
    HTMLPswAreaBuilder["__interfaces"] = ["ClassiPerCreazioneElementiHTML.ElementBuilder"];
